...
public class InMemoryDayWillRepository : IDayWillRepository
{
    ...
    public Task<IEnumerable<DayWill>?> ByDate(DateTime date)
    {
        ...
        {
            new(Guid.Parse("1d05b510-110c-4a5c-83f8-a86bd885d9ca"), new DateTime(2022, 01, 01),new Will("SleepEarly")),
            new(Guid.Parse("fcc57acb-d599-4164-9365-6ec688e37291"),new DateTime(2022, 01, 01),new Will("Sport")),
        });
    }
}